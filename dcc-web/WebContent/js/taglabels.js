$(document).ready(function () {
    ...
    function setTagItems() {
        ...
        $.each(tagItems, function (key, value) {
            tagLabelsElement.append("<span class=\"label label-primary tag-label\" tabindex=\"0\">" + value + "</span>");
        });
    }
    $("#tagList").on("keypress", ".tag-label", function (e) {
        if (e.which == 13) $("#tag").val($(this).text().toLowerCase());
    })
});